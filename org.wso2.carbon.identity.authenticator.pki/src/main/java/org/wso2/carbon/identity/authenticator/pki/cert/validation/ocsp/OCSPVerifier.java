 ...
 * under the License.
 */
package org.wso2.carbon.identity.authenticator.pki.cert.validation.ocsp;
...
/**
 * Used to check if a Certificate is revoked or not by its CA using Online
...
public class OCSPVerifier implements RevocationVerifier {
	...
	protected OCSPResp getOCSPResponce(String serviceUrl, OCSPReq request)
		...
		try {
			...
			throw new CertificateVerificationException("Cannot get ocspResponse from url: " +
			                                           serviceUrl, e);
		}
	}
	...
	private OCSPReq generateOCSPRequest(X509Certificate issuerCert, BigInteger serialNumber)
		...
		try {
			...
			throw new CertificateVerificationException(
			                                           "Cannot generate OSCP Request with the given certificate",
			                                           e);
		}
	}
	...
	private List<String> getAIALocations(X509Certificate cert)
		...
		try {
			...
			throw new CertificateVerificationException("Cannot read certificate to get OSCP urls",
			                                           e);
		}
